...
import useRecognizeNutritionFactsRemote from './useRecognizeNutritionFactsRemote'
...
export const RecognizeNutritionFactsRemote = (props: Props) => {
  ...
  const { loading, passioSpeechRecognitionModel, onScanImage } =
    useRecognizeNutritionFactsRemote(props)

  // Function to render each item in the FlatList
  const renderSearchItem = ({ item }: { item: PassioFoodItem }) => {
    return (
      <TouchableOpacity
      ...
      >
        ...
        <View>
          ...
          <Text style={styles.itemFoodName}>
            {item?.amount.selectedQuantity + ' |  ' + item?.amount.weightGrams}
          </Text>
        </View>
      </TouchableOpacity>
    )
  ...
  return (
    <SafeAreaView style={styles.body}>
      ...
      <TouchableOpacity onPress={onScanImage} style={styles.textInput}>
        <Text style={{ color: 'white' }}>Pick Nutrition Image</Text>
      </TouchableOpacity>
